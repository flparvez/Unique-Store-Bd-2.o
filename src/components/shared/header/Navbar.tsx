...
const admin = session.data?.user?.role==="admin"
  ...
  return (
    <header className="sm:sticky sm:top-0 sm:z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
      {/* Search Bar */}
      <div>
